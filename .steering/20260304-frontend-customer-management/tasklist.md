...
- [ ] **5.2 CustomerProfile（Presentational）**
...
- [ ] **6.1 ShippingAddressListContainer**
...
- [ ] データフェッチが Client Components で行われていない
- [ ] `error.tsx` が `"use client"` になっている
- [ ] Server Actions でバリデーションエラーを `throw` していない

...
export const devConfig: EnvConfig = {
  ...
  ecs: {
    cpu: 512, // 0.5 vCPU
    memory: 1024, // 1 GB
    desiredCount: 2, // TODO: イメージプッシュ後に2に変更
    minCapacity: 2, // TODO: イメージプッシュ後に2に変更
    maxCapacity: 4,
  },
  ...
  removalPolicy: {
    ...
    ecrRepositories: "DESTROY", // ECRリポジトリも削除
  },

  // GitHub Actions CI/CD設定
  github: {
    owner: "shinobu-takahata", // TODO: 実際のGitHub組織名またはユーザー名に変更
